...
#   url(r'^$', login_required(HomeView.as_view())),
  ...
  url(r'^events/plots/regions/(?P<eventId>\d+).png$', 'base.views.plot_region_event_pie_chart'),
  url(r'^events/plots/volumepie/(?P<eventId>\d+).png$', 'base.views.plot_volume_event_pie_chart'),
